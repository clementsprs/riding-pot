...
ride_4 = File.read('db/fixtures/ride4.txt') #Bordeaux
...
participation4.save
participation5 = Participation.new(user: user1, ride: ride2)
participation5.save
participation7 = Participation.new(user: user4, ride: ride2)
participation7.save
